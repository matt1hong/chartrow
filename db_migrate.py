...
script = api.make_update_script_for_model(application.config.SQLALCHEMY_DATABASE_URI, application.config.SQLALCHEMY_MIGRATE_REPO, tmp_module.meta, db.metadata)
